...
public class ValuesResponse extends AbstractResponse<Map<Key, Value>> {
    ...
    private Map<Key, Value> result;

    public ValuesResponse(String correlationId, Map<Key, Value> result) {
        super(correlationId);
        this.result = result;
    }
